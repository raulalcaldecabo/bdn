...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2022 a las 21:40:53
...
INSERT INTO `cursos` (`ID`, `nombre`, `descripcion`, `duracion`, `inicio`, `final`, `profesor`, `activo`) VALUES
(0, 'desarrollo web', 'un curso', 80, '2022-11-24', '2022-12-09', 1, '1'),
...
INSERT INTO `profesores` (`ID`, `dni`, `nombre`, `apellido`, `titulo`, `contrasena`, `foto`, `activo`) VALUES
(1, 99999999, 'sinprofe', 'sinprofe', 'uno', '827ccb0eea8a706c4c34a16891f84e7b', '', 1),
(2, 46543456, 'pedro', 'maravilla', '', '827ccb0eea8a706c4c34a16891f84e7b', '', 1);
